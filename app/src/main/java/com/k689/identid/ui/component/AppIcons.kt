...
object AppIcons {
    ...
    val YellowCard: IconDataUi =
        IconDataUi(
            resourceId = R.drawable.ic_yellow_card,
            contentDescriptionId = R.string.content_description_yellow_card_icon,
            imageVector = null,
        )

    val GreenCard: IconDataUi =
        IconDataUi(
            resourceId = R.drawable.ic_green_card,
            contentDescriptionId = R.string.content_description_green_card_icon,
            imageVector = null,
        )

    val RedCard: IconDataUi =
        IconDataUi(
            resourceId = R.drawable.ic_red_card,
            contentDescriptionId = R.string.content_description_red_card_icon,
            imageVector = null,
        )
    ...
    val KeyboardArrowDown: IconDataUi =
        IconDataUi(
            resourceId = null,
    ...
    val KeyboardArrowUp: IconDataUi =
        IconDataUi(
            resourceId = null,
    ...
    val KeyboardArrowRight: IconDataUi =
        IconDataUi(
            resourceId = null,
    ...
    val PresentDocumentInPerson: IconDataUi =
        IconDataUi(
    ...
    val PresentDocumentOnline: IconDataUi =
        IconDataUi(
    ...
    val AddDocumentFromList: IconDataUi =
        IconDataUi(
    ...
    val AddDocumentFromQr: IconDataUi =
        IconDataUi(
    ...
    val WalletActivated: IconDataUi =
        IconDataUi(
    ...
    val SignDocumentFromDevice: IconDataUi =
        IconDataUi(
    ...
    val SignDocumentFromQr: IconDataUi =
        IconDataUi(
