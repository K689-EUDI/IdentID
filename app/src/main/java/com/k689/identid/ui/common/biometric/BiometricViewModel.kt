...
package com.k689.identid.ui.common.biometric
...
import com.k689.identid.controller.authentication.BiometricsAuthenticate
                ...
                .collect {
                    when (it) {
                        is QuickPinInteractorPinValidPartialState.Failed -> {
                            val authAttempts = prefsPinStorageProvider.setIncorrectPinAttempts()
            ...
            when (val nav = navigation.navigationType) {
                is NavigationType.PopTo -> {
                    Effect.Navigation.PopBackStackUpTo(
                        ...
                        inclusive = false,
                        indicateFlowCompletion =
                            when (navigation.indicateFlowCompletion) {
